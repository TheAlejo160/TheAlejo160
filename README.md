...
<h3 align="center">Freelance Developer | Software & Electronic Engineering Student | Minecraft Plugin Creator | Mobile App Developer</h3>
...
- 🌱 **Actualmente:** Desarrollando soluciones móviles, aprendiendo continuamente nuevas tecnologías web para fortalecer mi perfil Fullstack, y **a punto de comenzar a aprender SQL** para el manejo de bases de datos.

### 🚀 Proyectos Destacados
* ☁️ **[TheAlejoCloud]** - *Lead Developer*: Mi proyecto más reciente centrado en el ecosistema móvil. Es una aplicación en desarrollo orientada a la nube, diseñada e implementada para funcionar de manera fluida tanto en **iOS** como en **Android**.
...
### 👨‍💻 About Me
I am a Software and Electronic Engineering student with a strong focus on **Backend and Mobile development**, steadily working my way towards becoming a Fullstack developer. I have a deep passion for video games, pure logic, optimizing complex systems, and creating unique experiences for users and players from the inside out.

- 🎓 **Education:** Software and Electronic Engineering student.
- 💻 **Specialty:** Java programming for advanced Minecraft plugins (Spigot/Paper), and **native and cross-platform mobile app development** for iOS and Android ecosystems.
...
- 🌱 **Currently:** Developing mobile solutions, continuously learning new web technologies to strengthen my Fullstack skills, and **about to start learning SQL** for database management.

### 🚀 Featured Projects
* ☁️ **[TheAlejoCloud]** - *Lead Developer*: My most recent project focused on the mobile ecosystem. It is an upcoming cloud-based application designed and developed to run seamlessly on both **iOS** and **Android**.
...
#### **Desarrollo Web & Otros / Web Development & Other**
<p align="left">
