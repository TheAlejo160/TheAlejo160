...
- 🌱 **Actualmente:** Desarrollando soluciones móviles nativas, gestionando mi entorno HomeLab en Linux, aprendiendo continuamente nuevas tecnologías web para fortalecer mi perfil Fullstack, y **a punto de comenzar a aprender SQL** para el manejo de bases de datos.
...
- 🌱 **Currently:** Developing native mobile solutions, managing my Linux HomeLab environment, continuously learning new web technologies to strengthen my Fullstack skills, and **about to start learning SQL** for database management.
